  ...
  return (
    <div>
      ...
      <input
        ...
        placeholder="Title"
        value={post.title}
        className="border-b pb-2 text-lg my-4 w-full font-light text-gray-500 placeholder-gray-500 y-2"
      />
      <SimpleMDE
        value={post.content}
      ...
      <button
        onClick={uploadImage}
        className="mb-4 bg-purple-600 text-while font-semibold px-8 py-2 rounded-lg"
      >
        Update Cover Image
      </button>
      <button
